                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" id="full-name-1" placeholder="English">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" id="email-address-1" placeholder="en">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="file" class="form-control form-control-lg form-control-file" id="phone-no-1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-lg btn-primary">Update Language</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
