                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-ulist is-compact">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-xxl"><span class="sub-text">Last Login</span>
                                            </div>
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-2">
                                                    <li class="nk-tb-action-hidden">
                                                        <a href="{{ route('admin.users.detail') }}" class="btn btn-sm btn-icon btn-trigger"
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-lg">
                                                <ul class="list-status">
                                                    <li><em class="icon text-info ni ni-alarm-alt"></em> <span>Email</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="nk-tb-col tb-col-xxl">
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-lg">
                                                <ul class="list-status">
                                                    <li><em class="icon text-warning ni ni-alarm-alt"></em>
                                                        <span>Email</span></li>
                                                </ul>
                                            </div>
                                            <div class="nk-tb-col tb-col-xxl">
