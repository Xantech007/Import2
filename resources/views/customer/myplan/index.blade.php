                        ...
                        <div class="nk-block-between-md g-4">
                            ...
                            <div class="nk-block-head-content">
                                <ul class="nk-block-tools gx-3">
                                    ...
                                    <li><a href="#" class="btn btn-white btn-light"><span>Invest More</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                        ...
                        <div class="card-inner-group">
                            <div class="card-inner">
                                <div class="row gy-gs">
                                        ...
                                        <div class="nk-iv-wg3">
                                            ...
                                            <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                                ...
                                                <div class="nk-iv-wg3-sub">
                                                    ...
                                                    <div class="nk-iv-wg3-subtitle">Locked Balance <em class="icon ni ni-info-fill" data-bs-toggle="tooltip" data-bs-placement="right" title="You can't use"></em></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                                    <div class="col-lg-7">
                                        <div class="nk-iv-wg3">
                                            <div class="nk-iv-wg3-title">This Month <em class="icon ni ni-info-fill" data-bs-toggle="tooltip" data-bs-placement="right" title="Current Month Profit"></em></div>
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="nk-iv-scheme-list">
                        ...
                        <div class="nk-iv-scheme-item">
                            ...
                            <div class="nk-iv-scheme-more">
                                <a class="btn btn-icon btn-lg btn-round btn-trans" href="{{ route('customer.myplan.detail') }}"><em class="icon ni ni-forward-ios"></em></a>
                            </div>
                            <div class="nk-iv-scheme-progress">
